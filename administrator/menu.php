	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
            ...
            <ul class="sub-menu">
                ...
                <li class="active"><a href="../menu/data-menu">Data Menu</a></li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Kelola Data Menu</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			...
			<div class="row">
			    ...
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <!-- end panel-heading -->
                          <br><a href="../menu/tambah-menu"><div class="pull-left"><button type="button" class="btn btn-success m-r-5 m-b-5" style="margin-left: 15px">Tambah Menu</div></a><br>    
                        <!-- begin panel-body -->
                            ...
                            <table id="data-table-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>-</td>
                                        <td>Aktif</td>
                                        <td><a href="../menu/edit-menu"><button type="button" class="btn btn-xs btn-warning"> Edit</button></a>
