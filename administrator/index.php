...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<ul class="nav">
         		...
         		<li class="active"><a href="index.html"><i class="ion-ios-pulse-strong bg-red"></i> <span>Dashboard</span></a></li>
          		<li class="has-sub">
            	<a href="javascript:;">
                <b class="caret"></b>
          ...
          <li><a href="user/data-user"><i class="fa fa-users bg-gradient-orange"></i> <span>Data User</span></a></li>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Dashboard <small>Ez Food...</small></h1>
			<!-- end page-header -->
