	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
            ...
            <ul class="sub-menu">
                ...
                <li class="active"><a href="../kategori/menu-kategori">Data Kategori</a></li>
            </ul>
          </li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Kelola Data Kategori</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
        ...
        <br><a href="../kategori/tambah-kategori"><div class="pull-left"><button type="button" class="btn btn-success m-r-5 m-b-5" style="margin-left: 15px">Tambah Kategori</div></a><br>       
                        ...
                        <div class="panel-body">
                            <table id="data-table-buttons" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                    	<th width="1%">No</th>
                                    	<th class="text-nowrap">Kode Kategori</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Makanan</td>
                                        <td>Dah lah</td>
                                        <td><a href="../kategori/edit-kategori"><button type="button" class="btn btn-xs btn-warning">Edit</button></a>
