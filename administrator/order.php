	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="index.html" class="navbar-brand"><span class="navbar-logo"><i class="ion-ios-cloud"></i></span> <b>M</b> Food</a>
		...
		<div id="sidebar" class="sidebar">
          ...
          <li class="active"><a href="../order/data-order"><i class="ion-ios-cart bg-gradient-blue"></i> <span>Data Order</span></a></li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Kelola Data Order</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			    ...
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Data Order</h4>
                        </div>
                        <!-- end panel-heading -->
                          <!---<br><a href="tambah_order.html"><div class="pull-left"><button type="button" class="btn btn-success m-r-5 m-b-5" style="margin-left: 15px">order</div></a><br>--->
                        <!-- begin panel-body -->
