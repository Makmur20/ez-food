...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
		  ...
		  <li class="active"><a href="../pelanggan/data-pelanggan"><i class="ion-person bg-purple"></i> <span>Data Pelanggan</span></a></li>
			    ...
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Data Pelanggan</h4>
                        </div>
                        <!-- end panel-heading -->
                            ...
                            <table id="data-table-buttons" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                    	...
                                    	<th class="text-nowrap">Kode Pelanggan</th>
