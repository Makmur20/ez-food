...
<body class="pace-top">
            ...
            <div class="login-content">
                <form action="Dashboard" method="POST" class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input type="text" class="form-control form-control-lg" name = "usrn" placeholder="Username" required />
                    </div>
                    <div class="form-group m-b-20">
                        <input type="password" class="form-control form-control-lg" name ="pw" placeholder="Password" required />
                    </div>
    ...
    if( isset($_POST['username']) && isset($_POST['pw'])){
        if ($_POST['usename'] == "makmur"){
            header_location('kategori.php');
        }else{
