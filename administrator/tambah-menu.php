...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
            ...
            <ul class="sub-menu">
            	<li class="active"><a href="../menu/tambah-menu">Tambah Menu</a></li>
          ...
          <li><a href="../user/data-user"><i class="ion-person-stalker bg-gradient-orange"></i> <span>Data User</span></a></li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Tambah Menu</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="kodemenu">Kode Menu * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="kodemenu" name="kodemenu" placeholder="Kode Menu" data-parsley-required="true" />
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="namamenu">Nama Menu * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="text" name="text" data-parsley-type="text" placeholder="Nama Menu" data-parsley-required="true" />
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="message">Kategori * :</label>
									<div class="col-md-8 col-sm-8">
							...
							<div class="form-group row">
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="harga">Harga :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="harga" name="harga" data-parsley-type="text" placeholder="Harga" data-parsley-required="true"/>
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="diskon">Diskon :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="diskon" name="diskon" data-parsley-type="diskon" placeholder="Diskon" />
									</div>
								</div>
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<textarea class="form-control" id="message" name="message" rows="4" data-parsley-range="[20,200]" placeholder="Deskripsi Menu"></textarea>
									</div>
								</div>
							...
							<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="Gambar">Gambar * :</label>
									<div class="col-md-8 col-sm-8">
