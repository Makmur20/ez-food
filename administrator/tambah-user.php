...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
           ...
           <li class="active"><a href="user.html"><i class="ion-person-stalker bg-gradient-orange"></i> <span>Data User</span></a></li>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
                            	<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="kode">Kode User * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="text" name="text" data-parsley-type="text" placeholder="Kode User" data-parsley-required="true" />
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="namauser">Nama User * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="text" name="text" data-parsley-type="text" placeholder="Nama User" data-parsley-required="true" />
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="usernanme">Username :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="usernanme" name="usernanme" data-parsley-type="text" placeholder="Username" data-parsley-required="true"/>
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="gmail">Gmail :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="gmail" id="gmail" name="gmail" data-parsley-type="text" placeholder="Gmail" data-parsley-required="true"/>
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="usernanme">Password :</label>
									<div class="col-md-8 col-sm-8">
									    <input data-toggle="password" data-placement="after" class="form-control" type="password" value="" placeholder="Password" />
									</div>
								</div>

								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="usernanme">Konfirmasi Password :</label>
									<div class="col-md-8 col-sm-8">
									    <input data-toggle="password" data-placement="after" class="form-control" type="password" value="" placeholder="Konfirmasi Password" />
									</div>
								</div>


								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="message">Hak Akses * :</label>
									<div class="col-md-8 col-sm-8">
									    <select class="form-control" data-parsley-required="true">
                                            <option value="" selected >Pilih Hak Akses</option>
                                            <option value="hakases">Superadmin</option>
                                            <option value="hakases">Operator</option>
                                            <option value="hakases">Kasir</option>
                                        </select>
								</div>
							</div>
							
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="status">Satus :</label>
									<div class="col-md-8 col-sm-8">
							...
							<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="Gambar">Foto * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="file" id="gambar" name="gambar" data-parsley-type="file" placeholder="Gambar" data-parsley-required="true" />
									</div>
								</div>
