	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
            ...
            <ul class="sub-menu">
                ...
                <li class="active"><a href="../kategori/tambah-kategori">Tambah Kategori</a></li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Tambah Kategori</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			    ...
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Form Tambah Kategori</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                            ...
                            <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="kodekategori" name="kodekategori" placeholder="Kode Kategori" data-parsley-required="true" />
									</div>
								</div>
